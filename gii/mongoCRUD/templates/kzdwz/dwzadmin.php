...
<?php echo '<?php'."\n"; ?>
	...
	<?php echo "//'showToolbar'=>false,		// 是否显示工具条\n" ?>
		'toolbar'=>array(
				...
				CHtml::link(CHtml::tag('span',array(),yii::t('admin','Delete')),Yii::app()->controller->createUrl('delete',array()),array('class'=>'delete','rel'=>$model->primaryKey,'target'=>'selectedTodo','posttype'=>'string','title'=>Yii::t('zii','Are you sure you want to delete this item?'))),
				
				CHtml::link(CHtml::tag('span',array(),Yii::t('admin','Update')),Yii::app()->controller->createUrl('update',array('id'=>'{'.$model->primaryKey.'}')),array('class'=>'edit','target'=>'dialog')),
				),
