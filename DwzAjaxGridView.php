 ...
 * @since 1.1
 */
class DwzAjaxGridView extends CBaseListView
{
	...
	*/
	...
	public function renderToolbar()
	{
		...
		echo CHtml::openTag('div',array('class'=>'panelBar'));
		echo CHtml::openTag('ul',array('class'=>'toolBar'));
		...
		{	
			...
			{
				$htmlOptions = array();
				if(isset($toolbar['htmlOptions']))
					$htmlOptions = $toolbar['htmlOptions'];
				echo CHtml::tag('li',$htmlOptions,$toolbar['value']);
			}else{
				echo CHtml::tag('li',array(),$toolbar);
			}
		}
	...
	<input type="hidden" name="orderDirection" value="${param.orderDirection}" />';
		...
		{
			echo "<table class=\"{$this->itemsCssClass}\" width='100%'>\n";
