...
<?php echo '<?php'."\n"; ?>
	...
	<?php echo "//'showToolbar'=>false,		// 是否显示工具条\n" ?>
		'toolbar'=>array(
				CHtml::link(CHtml::tag('span',array(),yii::t('app','Add')),Yii::app()->controller->createUrl('create'),array('class'=>'add','target'=>'dialog')),
				...
				CHtml::link(CHtml::tag('span',array(),yii::t('zii','Delete')),Yii::app()->controller->createUrl('delete',array()),array('class'=>'delete','rel'=>$model->getTableSchema()->primaryKey,'target'=>'selectedTodo','posttype'=>'string','title'=>Yii::t('zii','Are you sure you want to delete this item?'))),
				
				CHtml::link(CHtml::tag('span',array(),Yii::t('zii','Update')),Yii::app()->controller->createUrl('update',array('id'=>'{'.$model->getTableSchema()->primaryKey.'}')),array('class'=>'edit','target'=>'dialog')),
				),
