 ...
 * @since 1.1
 */
class DwzButtonColumn extends CGridColumn
{
	/**
	 ...
	 */
	public $viewButtonOptions=array('class'=>'btnView','target'=>'dialog');
	 ...
	 */
	public $updateButtonOptions=array('class'=>'btnEdit','target'=>'dialog');
	...
	protected function initDefaultButtons()
	{
		...
		if(!array_key_exists('title', $this->deleteButtonOptions))
			$this->deleteButtonOptions['title']=Yii::t('zii','Are you sure you want to delete this item?');
